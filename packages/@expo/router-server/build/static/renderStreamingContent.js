...
async function getStreamingContent(location, options) {
    ...
    const { element, getStyleElement } = (0, static_1.registerStaticRootComponent)(expo_router_1.ExpoRoot, {
        location,
        context: _ctx_1.ctx,
        wrapper: ({ children }) => (<server_1.ServerDocument Root={Root} payload={createServerDocumentPayload(getStyleElement, options)}>
        <div id="root">{children}</div>
      </server_1.ServerDocument>),
    });
    ...
    return server_2.default.renderToReadableStream(<head_1.default.Provider>
