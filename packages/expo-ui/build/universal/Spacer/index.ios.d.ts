 ...
 */
export declare function Spacer({ size, flexible, style, onAppear, onDisappear, disabled, hidden, testID, modifiers: extraModifiers, }: SpacerProps): import("react").JSX.Element;
export * from './types';
