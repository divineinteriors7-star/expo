 ...
 */
export declare function FieldSection({ children, title, style, onAppear, onDisappear, disabled, hidden, testID, titleUppercase, modifiers: extraModifiers, }: FieldSectionProps): import("react").JSX.Element | null;
