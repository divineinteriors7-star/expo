 ...
 */
export declare function FieldSection({ children, title, style, onAppear, onDisappear, hidden, testID, titleUppercase, }: FieldSectionProps): import("react").JSX.Element;
